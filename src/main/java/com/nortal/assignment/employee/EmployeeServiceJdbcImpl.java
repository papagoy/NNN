...
import com.nortal.assignment.record.RecordService;
import com.nortal.assignment.timetable.TimetableService;
...
public class EmployeeServiceJdbcImpl implements EmployeeService {
  ...
  public void delete(Long employeeId) {
	  timetableService.deleteRecordEmployees(employeeId);
	  recordService.deleteRecordEmployees(employeeId);
