...
public class Record {
  ...
  public String getEmployeeNames() {
	    // TODO: Create a string with all employee names
		  Collections.sort(employees, new Employee.OrderBySalary());
		  String employeeNamesBySalary= "";
		  for(int i = 0; i<this.employees.size();i++){
			employeeNamesBySalary = employeeNamesBySalary + this.employees.get(i).getEmployeeName() +",";
		  }
		  
	    return employeeNamesBySalary;
	  }
...
public String getProjectNames() {
	    // TODO: Create a string with all project names
		  ...
		  for(int i = 0; i<this.projects.size();i++){
			  projectName = projectName + this.projects.get(i).getProjectName() + ",";
		  }
  ...
  public String toString(){
	  ...
	  return id.toString()+" " + date +" "+type +" "+content+" "+employees+" "+projects;
