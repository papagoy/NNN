      ...
      <div class="row">
        <div class="col-sm-4">
          ...
          <ul>
            ...
            <li><c:out value="The worst executed project is: ${worstExecutedProject.projectName}" /></li>
            <li><c:out value="The best executed project is: ${bestExecutedProject.projectName}" /></li>
          </ul>
        </div>
        <div class="col-sm-8">
